...
import 'package:toto_partner/features/disbursement/domain/models/disbursement_method_model.dart';
...
import 'package:toto_partner/features/payment/domain/models/bank_info_body_model.dart';
import 'package:toto_partner/features/payment/domain/models/earning_history_model.dart';
import 'package:toto_partner/features/payment/domain/models/wallet_payment_model.dart';
import 'package:toto_partner/features/payment/domain/models/widthdrow_method_model.dart';
import 'package:toto_partner/features/payment/domain/models/withdraw_model.dart';
...
class PaymentController extends GetxController implements GetxService {
  ...
  List<EarningHistory>? _earningHistory;
  List<EarningHistory>? get earningHistory => _earningHistory;
  ...
  void setPaymentMethod(String value) {
    if (value.startsWith('my_')) {
      ...
      final selectedMethod =
          myMethodList?.firstWhereOrNull((e) => e.id.toString() == id);
      ...
      final selectedMethod = _widthDrawMethods!
  ...
  Future<void> getEarningHistory() async {
    _earningHistory = null;
    List<EarningHistory>? earningHistory =
        await paymentServiceInterface.getEarningHistory();
    if (earningHistory != null) {
      _earningHistory = [];
      _earningHistory!.addAll(earningHistory);
    }
    update();
  }
}
