...
class _PaymentSuccessfulScreenState extends State<PaymentSuccessfulScreen> {
  ...
  Future<void> _loadTrialWidgetShow() async {
    await Get.find<ProfileController>()
        .trialWidgetShow(route: RouteHelper.success);
  }
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          Image.asset(widget.success ? Images.checked : Images.warning,
              width: 100,
              height: 100,
              color: widget.success ? Theme.of(context).primaryColor : null),
