...
import 'package:toto_partner/features/payment/widgets/wallet_card_widget.dart';
import 'package:toto_partner/features/payment/widgets/wallet_attention_alert_widget.dart';
import 'package:toto_partner/features/payment/widgets/wallet_widget.dart';
import 'package:toto_partner/features/payment/widgets/withdraw_widget.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  void initState() {
    ...
    Get.find<PaymentController>().getEarningHistory();
              ...
              ? profileController.modulePermission!.myWallet!
                  ? RefreshIndicator(
                      onRefresh: () async {
                        ...
                        await Get.find<PaymentController>().getEarningHistory();
                      },
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    Expanded(
                                      child: WalletWidget(
                                          ...
                                          image: Images.pendingWithdrawBgIcon),
                                    ),
                                    const SizedBox(
                                        width: Dimensions.paddingSizeSmall),
                                    Expanded(
                                  ...
                                  WalletWidget(
                                      ...
                                      image: Images.totalWithdrawBgIcon),
                                  Padding(
                                  ...
                                  if (paymentController.selectedIndex == 0 ||
                                      paymentController.selectedIndex == 1)
                                    Row(
                                        mainAxisAlignment:
                                          ...
                                          InkWell(
                                            onTap: () {
                                              ...
                                              if (paymentController
                                                      .selectedIndex ==
                                                  2) {
                                                // Earning history - can navigate to full screen if needed
                                              }
                                            },
                                            child: Padding(
                                              padding:
                                    ...
                                    paymentController.transactions != null
                                                      ...
                                                      child: Row(children: [
                                                        Expanded(
                                                          child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    PriceConverter.convertPrice(paymentController
                                                                        .transactions![
                                                                            index]
                                                                        .amount),
                                                                    style: robotoMedium.copyWith(
                                        ...
                                        : const Center(
                                            child: Padding(
                                                ...
                                                child:
                                                    CircularProgressIndicator())),
                                  if (paymentController.selectedIndex == 2)
                                    paymentController.earningHistory != null
                                        ? paymentController
                                                .earningHistory!.isNotEmpty
                                            ? ListView.builder(
                                                itemCount: paymentController
                                                            .earningHistory!
                                                            .length >
