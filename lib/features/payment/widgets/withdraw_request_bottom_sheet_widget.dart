...
class _WithdrawRequestBottomSheetWidgetState
  ...
  void initState() {
    ...
    _amountController.text =
        Get.find<ProfileController>().profileModel!.balance.toString();
    ...
    return Container(
      ...
      child:
        ...
        return GetBuilder<PaymentController>(builder: (paymentController) {
          final myMethodList =
              disbursementController.disbursementMethodBody?.methods;
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(
                ...
                child: Column(children: [
                      ...
                      int? id = value.startsWith('my_')
                          ? myMethodList
                              .firstWhereOrNull((method) =>
                                  method.methodName == value.split('_').last)
                              ?.withdrawalMethodId
                          : othersMethodList
                              .firstWhereOrNull((method) =>
                                  method.methodName ==
                                  value.replaceFirst('other_', ''))
                              ?.id;
                  ...
                  SizedBox(
                      height: paymentController.methodFields.isNotEmpty ||
                              paymentController.disMethodFields.isNotEmpty
                          ...
                          child: Column(children: [
                            Row(children: [
                              const CustomAssetImageWidget(
                                  image: Images.paymentMethodIcon,
                                  height: 30,
                                  width: 30,
                                  fit: BoxFit.cover),
                              const SizedBox(
                            ...
                            ListView.builder(
                              itemCount:
                                  paymentController.disMethodFields.length,
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: Row(children: [
                                    Text(
                                      paymentController
                                              .disMethodFields[index].userInput!
                                              .replaceAll('_', ' ')
                                              .capitalize ??
                                          '',
                                    ...
                                    inputType: paymentController
                                        ...
                                        : paymentController.methodFields[index]
                                            ...
                                            : paymentController
                                                ...
                                                : TextInputType.name,
                                    focusNode:
                                        paymentController.focusList[index],
                                    nextFocus: index !=
                                            paymentController
                                                    .methodFields.length -
                                                1
                  ...
                  Builder(builder: (context) {
                    ...
                    for (var element in paymentController.methodFields) {
                      if (element.isRequired == 1) {
                        if (paymentController
                            .textControllerList[
                                paymentController.methodFields.indexOf(element)]
                            .text
                            .isEmpty) {
                          fieldEmpty = true;
                        }
                    ...
                    return CustomButtonWidget(
                      ...
                      onPressed: !fieldEmpty &&
                              paymentController.selectedPaymentMethodId !=
                                  null &&
                          ...
                          ? () {
                              if (fieldEmpty) {
                                ...
                                if (paymentController.selectedPaymentMethod!
                                    .startsWith('my_')) {
                                  for (var result
                                      in paymentController.disMethodFields) {
                                    data[result.userInput] = paymentController
                                        .textControllerList[paymentController
                                            .disMethodFields
                                            .indexOf(result)]
                                        .text
                                        .trim();
                                  ...
                                  for (var result
                                      in paymentController.methodFields) {
