...
class PaymentRepository implements PaymentRepositoryInterface {
  ...
  @override
  Future<List<EarningHistory>?> getEarningHistory() async {
    List<EarningHistory>? earningHistory;
    Response response = await apiClient.getData(AppConstants.earningHistoryUri);
    if (response.statusCode == 200) {
      earningHistory = [];
      EarningHistoryModel earningHistoryModel =
          EarningHistoryModel.fromJson(response.body);
      earningHistory.addAll(earningHistoryModel.earningHistory!);
    }
