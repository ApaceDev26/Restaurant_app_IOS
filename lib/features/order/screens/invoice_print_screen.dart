...
import 'package:toto_partner/features/order/widgets/invoice_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
                  ...
                  child: DropdownButton<int>(
                    ...
                    items: _paperSizeList.map((int? value) {
                      return DropdownMenuItem<int>(
                          value: value, child: Text('$value' 'mm'));
                    }).toList(),
                    onChanged: (int? value) {
                      setState(() {
                        _selectedSize = value!;
        ...
        CustomButtonWidget(
          buttonText: _printLoading ? 'printing'.tr : 'print_invoice'.tr,
          height: 40,
          margin: const EdgeInsets.symmetric(
              horizontal: Dimensions.paddingSizeSmall,
              vertical: Dimensions.paddingSizeExtraSmall),
          onPressed: _printLoading
              ? null
              : () {
                  setState(() {
                    _printLoading = true;
