...
import 'package:toto_partner/features/order/widgets/count_widget.dart';
import 'package:toto_partner/features/order/widgets/order_view_widget.dart';
...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  void initState() {
    super.initState();
    Get.find<OrderController>().changeOrderTypeIndex(
        Get.find<ProfileController>().modulePermission!.regularOrder! ? 0 : 1,
        isUpdate: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Get.find<ProfileController>().modulePermission!.regularOrder! ||
