...
import 'package:toto_partner/features/order/widgets/price_widget.dart';
                ...
                children: [
                      ...
                      ? Align(
                          ...
                          child: Column(children: [
                            order?.orderReference?.tableNumber != null
                                ? Text(
                                    '${'table_number'.tr}: ${order?.orderReference?.tableNumber ?? ''}',
                                    style: robotoRegular.copyWith(
                                        fontSize: fontSize))
                                : const SizedBox(),
                            order?.orderReference?.tokenNumber != null
                                ? Text(
                                    '${'token_number'.tr}: ${order?.orderReference?.tokenNumber ?? ''}',
                                    style: robotoRegular.copyWith(
                                        fontSize: fontSize))
                                : const SizedBox(),
                          ]),
                  ...
                  Align(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text(
                              '${order!.customer?.fName ?? 'guest'.tr} ${order!.customer?.lName ?? 'user'.tr}',
                              style:
                  ...
                  PriceWidget(
                    title:
                        '${'vat_tax'.tr} ${order!.taxStatus! ? 'vat_tax_inc'.tr : ''}',
                  ...
                  (order!.extraPackagingAmount! > 0) &&
                      ...
                      : const SizedBox(),
                  SizedBox(
                      height: (order!.extraPackagingAmount! > 0) &&
                              order!.orderType != 'dine_in'
                          ? 5
                          : 0),
                  PriceWidget(
