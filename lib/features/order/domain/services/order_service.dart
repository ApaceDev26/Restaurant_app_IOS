...
class OrderService implements OrderServiceInterface {
  ...
  Future<PaginatedOrderModel?> getPaginatedOrderList(
    ...
    return await orderRepositoryInterface.getPaginatedOrderList(
        offset: offset, status: status, isSubscription: isSubscription);
  }
  ...
  @override
  Future<bool> addDineInTableAndTokenNumber(
      int? orderId, String? tableNumber, String? tokenNumber) async {
    return await orderRepositoryInterface.addDineInTableAndTokenNumber(
