...
import 'package:toto_partner/features/expense/widgets/expense_card_widget.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<ExpenseController>(builder: (expenseController) {
        return Column(children: [
              ...
              InkWell(
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        color: expenseController.from != null &&
                                expenseController.to != null
                            ? Theme.of(context).primaryColor
                            : null,
                        borderRadius:
                            BorderRadius.circular(Dimensions.radiusSmall),
                        border: expenseController.from != null &&
                                expenseController.to != null
                            ? null
                            : Border.all(
          ...
          expenseController.from != null && expenseController.to != null
