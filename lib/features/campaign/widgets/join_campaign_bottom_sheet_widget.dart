...
class JoinCampaignBottomSheetWidget extends StatelessWidget {
  ...
  const JoinCampaignBottomSheetWidget(
      {super.key, required this.isJoined, required this.campaignID});
      ...
      child: GetBuilder<CampaignController>(builder: (campaignController) {
        return Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const CustomAssetImageWidget(
            image: Images.confirmCampaignIcon,
            height: 70,
            width: 70,
          ),
          ...
          Text(
              isJoined
                  ? 'want_to_leave_from_this_campaign'.tr
                  : 'want_to_join_the_campaign'.tr,
              style: robotoBold.copyWith(fontWeight: FontWeight.w600)),
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: Dimensions.paddingSizeLarge),
            child: Text('join_campaign_description'.tr,
                style:
