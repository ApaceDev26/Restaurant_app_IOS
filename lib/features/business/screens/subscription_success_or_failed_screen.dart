    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        if (widget.success) {
          ...
          Get.offAllNamed(RouteHelper.getSubscriptionPaymentRoute(
              restaurantId: widget.restaurantId, packageId: widget.packageId));
        }
      },
      child: Scaffold(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(
                        ...
                        top: Dimensions.paddingSizeOverExtraLarge,
                            ...
                            ? Column(
                                ...
                                children: [
                                              ...
                                              TextSpan(
                                                  text: widget.fromSubscription
                                                      ? 'subscription_success_message'
                                                          .tr
                                                      : 'commission_base_success_message'
                                                          .tr),
                                            ]),
                                      ),
                                    ),
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        Get.find<AuthController>()
                                            .saveIsRestaurantRegistrationSharedPref(
                                                true);
                                        Get.offAllNamed(
