...
import 'package:toto_partner/helper/pdf_download_helper.dart';
...
class ReportController extends GetxController implements GetxService {
  ...
  void initTaxReportDate() {
    _from = DateConverter.dateTimeForTax(
  ...
  Future<void> getTransactionReportStatement(int orderId) async {
    ...
    Response response = await reportServiceInterface
        .getTransactionReportStatement(orderId: orderId);
