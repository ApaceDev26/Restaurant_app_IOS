...
import 'package:toto_partner/features/reports/widgets/report_card_widget.dart';
        ...
        child: GetBuilder<ProfileController>(builder: (profileController) {
          return Column(children: [
            profileController.modulePermission!.expenseReport!
                ...
                : const SizedBox(),
            SizedBox(
                height: profileController.modulePermission!.expenseReport!
                    ? Dimensions.paddingSizeDefault
                    : 0),
            profileController.modulePermission!.transaction!
                ? ReportCardWidget(
                    title: 'transaction_report'.tr,
                    subtitle:
                        'view_all_incoming_and_outgoing_payment_records'.tr,
                ...
                : const SizedBox(),
            SizedBox(
                height: profileController.modulePermission!.transaction!
                    ? Dimensions.paddingSizeDefault
                    : 0),
            profileController.modulePermission!.orderReport!
                ? ReportCardWidget(
                ...
                : const SizedBox(),
            SizedBox(
                height: profileController.modulePermission!.orderReport!
                    ? Dimensions.paddingSizeDefault
                    : 0),
            profileController.modulePermission!.foodReport!
                ? ReportCardWidget(
                ...
                : const SizedBox(),
            SizedBox(
                height: profileController.modulePermission!.foodReport!
                    ? Dimensions.paddingSizeDefault
                    : 0),
            profileController.modulePermission!.campaign!
                ? ReportCardWidget(
                ...
                : const SizedBox(),
            SizedBox(
                height: profileController.modulePermission!.campaign!
                    ? Dimensions.paddingSizeDefault
                    : 0),
            profileController.modulePermission!.taxReport!
                ? ReportCardWidget(
                    title: 'vat_report'.tr,
                    subtitle:
                        'see_vat_collected_and_applied_on_transactions'.tr,
