...
import 'package:toto_partner/features/reports/screens/tax/widgets/tax_report_bottom_sheet.dart';
import 'package:toto_partner/helper/date_converter_helper.dart';
import 'package:toto_partner/helper/extensions_helper.dart';
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
          ...
          Get.find<ReportController>().orderList != null &&
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
        title: 'vat_report'.tr,
        menuWidget: InkWell(
          onTap: () => Get.find<ReportController>()
              .showDatePicker(context, isTaxReport: true),
          child: Container(
      ...
      body: GetBuilder<ReportController>(builder: (reportController) {
        return reportController.taxReportModel != null &&
                reportController.orderList != null
            ? SingleChildScrollView(
                ...
                child: Column(children: [
                    ...
                    Row(children: [
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                const Color(0xffD89D4B).withValues(alpha: 0.05),
                            borderRadius:
                                ...
                                Expanded(
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            reportController
                                                .taxReportModel!.totalOrders
                                                .toString(),
                                            style: robotoBlack.copyWith(
                                                color: const Color(0xffD89D4B),
                                                fontSize: Dimensions
                                                    .fontSizeExtraLarge)),
                                      ]),
                                ),
                                CustomAssetImageWidget(
                                    image: Images.taxOrderIcon,
                                    height: 30,
                                    width: 30,
                      ...
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                const Color(0xff0661CB).withValues(alpha: 0.05),
                            borderRadius:
                                BorderRadius.circular(Dimensions.radiusDefault),
                          ),
                          child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            PriceConverter.convertPrice(
                                                reportController.taxReportModel
                                                        ?.totalOrderAmount ??
                                                    0),
                                            style: robotoBlack.copyWith(
                                                color: const Color(0xff0661CB),
                                                fontSize: Dimensions
                                                    .fontSizeExtraLarge)),
                                      ]),
                                ),
                                const CustomAssetImageWidget(
                                    image: Images.taxAmountIcon,
                                    height: 30,
                                    width: 30),
                              ]),
                        ),
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                itemCount: reportController
                                    .taxReportModel?.taxSummary?.length,
                                shrinkWrap: true,
                  ...
                  reportController.orderList!.isNotEmpty
                      ? ListView.builder(
                            ...
                            return InkWell(
                              onTap: () {
                                showCustomBottomSheet(
                                    child: TaxReportBottomSheet(
                                        orderList: reportController
                                            .orderList![index]));
                              },
                              child: Container(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      '${'order'.tr} #${reportController.orderList?[index].id}',
                                                      style: robotoMedium.copyWith(
                                                          color:
                                                              Theme.of(context)
                                                                  .textTheme
                                    ...
                                    child: Row(children: [
                                      Expanded(
                                        child: Column(
                                            ...
                                            children: [
                                              Text(
                                                  '${'tax'.tr}: ${PriceConverter.convertPrice(reportController.orderList?[index].totalTaxAmount ?? 0)}',
                                              ...
                                              const SizedBox(
                                                  height: Dimensions
                                                          .paddingSizeExtraSmall -
                                                      2),
                                              reportController.orderList![index]
                                                      .orderTaxes!.isNotEmpty
                                                  ? Wrap(
                                                      alignment:
                                                          WrapAlignment.start,
                                                      children: List.generate(
                                                        ...
                                                        (i) => Padding(
                                                          padding: EdgeInsets.only(
                                                              right: i ==
                                                                      (reportController.orderList![index].orderTaxes?.length ??
                                                                              0) -
                                                                          1
                                                                  ? 0
                                                                  : Dimensions
