    ...
    return Container(
      ...
      child: GetBuilder<ProfileController>(builder: (profileController) {
        ...
        if (profileController.profileModel != null) {
          payTheDue = (profileController.profileModel!.cashInHands != 0 &&
        ...
        return Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          CustomAssetImageWidget(
            image: payTheDue
                ? Images.accountDeleteWarningIcon
                : Images.accountDeleteIcon,
            height: 60,
            width: 60,
          ),
          const SizedBox(height: 35),
          Text(
              payTheDue
                  ? 'sorry_you_can_not_delete_your_account'.tr
