...
import 'package:toto_partner/features/business/domain/models/package_model.dart';
import 'package:toto_partner/features/business/widgets/base_card_widget.dart';
import 'package:toto_partner/features/business/widgets/package_card_widget.dart';
...
import 'package:toto_partner/features/auth/domain/models/restaurant_body_model.dart';
import 'package:toto_partner/features/auth/widgets/additional_data_section_widget.dart';
import 'package:toto_partner/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:toto_partner/features/auth/widgets/pass_view_widget.dart';
import 'package:toto_partner/features/auth/widgets/select_location_view_widget.dart';
                    ...
                    child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              height: 2,
                              color: authController.storeStatus == 0.1
                                  ? Theme.of(context)
                                      .primaryColor
                          ...
                          Expanded(
                            child: Container(
                              height: 2,
                              color: authController.storeStatus == 0.6
                                  ? Theme.of(context)
                                      .primaryColor
                                      .withValues(alpha: 0.5)
                          ...
                          Expanded(
                            child: Container(
                              height: 2,
                              color: authController.storeStatus == 0.9
                                  ? Theme.of(context)
                                      .primaryColor
                                      .withValues(alpha: 0.5)
                                  : Theme.of(context)
              ...
              body: Column(children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            'insert_language_wise_restaurant_name'
                                                .tr,
                                        ...
                                        CustomTextFieldWidget(
                                          hintText:
                                              '${'restaurant_name'.tr} (${_languageList?[_tabController!.index].value!})',
                                          labelText:
                                              '${'restaurant_name'.tr} (${_languageList?[_tabController!.index].value!})',
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(
                                            height: Dimensions
                                                .paddingSizeExtraSmall),
                                        Text(
                                            'image_format_and_ratio_for_logo'
                                                .tr,
                                            style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall,
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(
                                            height: Dimensions
                                                .paddingSizeExtraSmall),
                                        Text(
                                            'image_format_and_ratio_for_cover'
                                                .tr,
                                            style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall,
                                                        ...
                                                        ? Swiper(
                                                            itemCount:
                                                                authController
                                                                    ...
                                                                    .packages!
                                                                    .length,
                                                            viewportFraction: authController
                                                                        .packageModel!
                                                                        .packages!
                                                                        .length >
                                                                    1
                ...
                ((authController.storeStatus == 0.9) &&
                        (Get.find<SplashController>()
                            ...
                            0) &&
                        (authController.packageModel != null &&
                            authController.packageModel!.packages!.isEmpty))
                    ? const SizedBox()
                    : !authController.isLoading
                        ? Container(
                            ...
                            child: CustomButtonWidget(
                              buttonText: authController.storeStatus == 0.1 ||
                              ...
                              onPressed: () {
                                ...
                                if (authController.storeStatus != 0.1) {
                                  for (Data data in authController.dataList!) {
                                    ...
                                    int index =
                                        authController.dataList!.indexOf(data);
                                    ...
                                    if (isTextField) {
                                      ...
                                      if (authController.additionalList![index]
                                                  .length ==
                                              0 &&
                                          isRequired) {
                                        customFieldEmpty = true;
                                ...
                                if (authController.storeStatus == 0.1 ||
                                  ...
                                  } else if (authController.storeStatus ==
                                      0.6) {
                                    if (fName.isEmpty) {
                                      showCustomSnackBar(
                                  ...
                                  data.addAll(RestaurantBodyModel(
                                    ...
                                    packageId:
                                        authController.packageModel!.packages !=
                                            ...
                                            : '',
                                    tin: tin,
                                    tinExpireDate: authController.tinExpireDate,
                                  ).toJson());
