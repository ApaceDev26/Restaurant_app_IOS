import 'dart:convert';
import 'package:toto_partner/features/auth/domain/models/address_model.dart';
import 'package:toto_partner/features/auth/domain/models/prediction_model.dart';
import 'package:toto_partner/features/auth/domain/models/zone_model.dart';
import 'package:toto_partner/features/auth/domain/models/zone_response_model.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  void setZoneIndex(int? index, {GoogleMapController? mapController}) {
    ...
    if (index == null ||
        index < 0 ||
        _zoneList == null ||
        index >= _zoneList!.length) {
      return;
    }

    final points = _zoneList![index].formatedCoordinates;
    ...
    zoomToFit(mapController, points, padding: 0.4);
    setLocation(center);
  }
  ...
  Future<void> zoomToFit(
    ...
    try {
      ...
      await googleMapController.moveCamera(CameraUpdate.newCameraPosition(
          CameraPosition(
              target: centerBounds, zoom: GetPlatform.isWeb ? 10 : 14)));
