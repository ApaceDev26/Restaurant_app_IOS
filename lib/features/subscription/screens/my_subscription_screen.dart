...
import 'package:toto_partner/features/subscription/widgets/change_subscription_plan_bottom_sheet.dart';
import 'package:toto_partner/features/subscription/widgets/subscription_details_widget.dart';
import 'package:toto_partner/features/subscription/widgets/transaction_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SubscriptionController>(
      ...
      bool businessIsCommission = subscriptionController
          ...
          'commission';
      bool businessIsNone = subscriptionController
              .profileModel!.restaurants![0].restaurantBusinessModel ==
          'none';
      bool businessIsUnsubscribed = subscriptionController
              .profileModel!.restaurants![0].restaurantBusinessModel ==
          'unsubscribed';

      return PopScope(
        canPop: !widget.fromNotification && Navigator.of(context).canPop(),
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                '${Get.find<ProfileController>().profileModel != null && Get.find<ProfileController>().profileModel!.restaurants?[0].comission != null && Get.find<ProfileController>().profileModel!.restaurants![0].comission! > 0 ? Get.find<ProfileController>().profileModel!.restaurants![0].comission! : Get.find<SplashController>().configModel?.adminCommission} %',
                                style: robotoBold.copyWith(
