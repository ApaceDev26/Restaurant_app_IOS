...
class RestaurantService implements RestaurantServiceInterface {
  ...
  Future<ProductModel?> getProductList(
    ...
    return await restaurantRepositoryInterface.getProductList(
        offset, type, stockType, categoryId);
  }

  @override
  Future<bool> updateRestaurantBasicInfo(Restaurant restaurant, XFile? logo,
      XFile? cover, List<Translation> translation, XFile? metaImage) async {
    return await restaurantRepositoryInterface.updateRestaurantBasicInfo(
        restaurant, logo, cover, translation, metaImage);
  }

  @override
  Future<bool> updateRestaurant(Restaurant restaurant, List<String> cuisines,
      String characteristics, String tags) async {
