...
class RestaurantRepository implements RestaurantRepositoryInterface {
  ...
  Future<bool> updateRestaurantBasicInfo(Restaurant restaurant, XFile? logo,
    ...
    Response response = await apiClient
        .postMultipartData(AppConstants.restaurantBasicInfoUpdateUri, fields, [
  ...
  Future<bool> updateRestaurant(Restaurant restaurant, List<String> cuisines,
    ...
    fields.addAll(<String, String>{
      ...
      'tags': tags,
      'halal_tag_status': restaurant.isHalalActive! ? '1' : '0',
    });
    ...
    Response response =
        await apiClient.postData(AppConstants.restaurantUpdateUri, fields);
    return (response.statusCode == 200);
  }
