...
abstract class RestaurantRepositoryInterface implements RepositoryInterface {
  Future<dynamic> getProductList(
      String offset, String type, String stockType, int? categoryId);
  Future<dynamic> updateRestaurantBasicInfo(Restaurant restaurant, XFile? logo,
      XFile? cover, List<Translation> translation, XFile? metaImage);
  Future<dynamic> updateRestaurant(Restaurant restaurant, List<String> cuisines,
      String characteristics, String tags);
