...
import 'package:toto_partner/common/widgets/product_shimmer_widget.dart';
import 'package:toto_partner/common/widgets/product_widget.dart';
      ...
      if (scrollController.position.pixels ==
        ...
        if (Get.find<RestaurantController>().offset < pageSize) {
          ...
          Get.find<RestaurantController>().getProductList(
            offset: Get.find<RestaurantController>().offset.toString(),
            foodType: Get.find<RestaurantController>().selectedFoodType,
            stockType: Get.find<RestaurantController>().selectedStockType,
            categoryId: Get.find<RestaurantController>().categoryId,
          );
        }
      }
