...
class _UpdateStockBottomSheetState extends State<UpdateStockBottomSheet> {
  ...
  void initState() {
    ...
    variationStockControllers = widget.product.variations!
        .map((variation) => variation.variationValues!
            .map((variationValue) => TextEditingController(
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        Expanded(
                            child: Text('variation'.tr, style: robotoRegular)),
                          ...
                          return Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    itemCount: widget.product.variations![index]
                    ...
                    ? CustomButtonWidget(
                        ...
                        onPressed: () {
                          restaurantController.updateProductStock(
                            ...
                            variationStock: variationStockControllers
                                .map((variationController) =>
                                    variationController
