...
import 'package:toto_partner/features/restaurant/widgets/filter_data_bottom_sheet.dart';
import 'package:toto_partner/features/profile/domain/models/profile_model.dart';
import 'package:toto_partner/features/restaurant/widgets/product_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      return GetBuilder<ProfileController>(builder: (profileController) {
        ...
        return Get.find<ProfileController>().modulePermission!.myRestaurant!
            ? Scaffold(
                ...
                floatingActionButton: GetBuilder<RestaurantController>(
                  ...
                  return restaurantController.isFabVisible
                      ? Column(
                    ...
                    ? CustomScrollView(
                        ...
                        slivers: [
                          SliverAppBar(
                            ...
                            elevation: 2,
                            title: restController.isTitleVisible
                                ? Row(
                                    children: [
                                      ClipOval(
                            ...
                            actions: restController.isTitleVisible
                                ? [
                                    InkWell(
                                      onTap: () => Get.toNamed(
                                          RouteHelper.getRestaurantEditRoute(
                                              restaurant)),
                                      child: Container(
                                        height: 35,
                                        width: 35,
                          ...
                          Get.find<ProfileController>().modulePermission!.food!
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(children: [
                                        ...
                                        const SizedBox(
                                            height:
                                                Dimensions.paddingSizeLarge),
                                        restController.categoryNameList != null
                                            ? SizedBox(
                                                height: 30,
                                      ...
                                      onVegFilterTap: (String type) {
                                        Get.find<RestaurantController>()
                                            .getProductList(
                                                offset: '1',
                                                foodType: type,
                                                stockType: restController
                                                    .selectedStockType,
                                                categoryId:
                                                    restController.categoryId);
                                      }),
                                )
                              : const SliverToBoxAdapter(child: SizedBox()),
                        ],
...
class SliverDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool shouldRebuild(SliverDelegate oldDelegate) {
    return oldDelegate.maxExtent != 100 ||
        oldDelegate.minExtent != 100 ||
