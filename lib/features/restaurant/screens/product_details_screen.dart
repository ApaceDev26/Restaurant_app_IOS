...
import 'package:toto_partner/common/widgets/rating_bar_widget.dart';
...
import 'package:toto_partner/features/restaurant/widgets/update_stock_bottom_sheet.dart';
...
class ProductDetailsScreen extends StatefulWidget {
  ...
  const ProductDetailsScreen(
      {super.key, required this.product, this.isCampaign});
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    Get.find<RestaurantController>()
        .setAvailability(widget.product.status == 1);
    Get.find<RestaurantController>()
        .setRecommended(widget.product.recommendedStatus == 1);
  ...
  Widget build(BuildContext context) {
    double? discount =
        (widget.product.restaurantDiscount == 0 || (widget.isCampaign ?? false))
        ...
        child: GetBuilder<RestaurantController>(builder: (restController) {
          return Column(children: [
              ...
              child: Column(
                  ...
                  children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          widget.product.stockType ==
                                                  'unlimited'
                                              ? 'unlimited'.tr
                                              : widget.product.itemStock! > 0
                                                  ? widget.product.itemStock
                                                      .toString()
                                                  : 'out_of_stock'.tr,
                                          style: robotoMedium.copyWith(
                                              color: Theme.of(context)
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        FlutterSwitch(
                          ...
                          onToggle: (bool isActive) {
                            restController
                                .toggleRecommendedProduct(widget.product.id);
                          },
                        ),
                      ]),
                    ),
                                    ...
                                    Row(
                                        ...
                                        children: [
                                          ...
                                          widget.product.stockType ==
                                              ...
                                              ? CustomToolTip(
                                                  message:
                                                      'your_main_stock_is_empty_variations_stock_will_not_work_if_the_main_stock_is_empty'
                                                          .tr,
                                                  preferredDirection:
                                                      AxisDirection.down,
                                                )
                                                                ...
                                                                children: [
                                                                  ...
                                                                  const SizedBox(
                                                                      height: Dimensions
                                                                          .paddingSizeExtraSmall),
                                                                  Text(
                                                                    PriceConverter.convertPrice(_convertStringToDouble(widget
                                                                        .product
                                                                        .variations![
                                                                            index]
                                                                        .variationValues![
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    widget.product.stockType ==
                                                                        ...
                                                                        ? 'unlimited'
                                                                            .tr
                                                                        : _convertStringToInt(widget.product.variations![index].variationValues![i].currentStock!)! >
                                                                                0
                                                                            ? widget.product.variations![index].variationValues![i].currentStock!
                                                                            : 'out_of_stock'.tr,
                                                                    style: robotoRegular.copyWith(
                                                                        fontSize:
                                                                            Dimensions
                    ...
                    widget.product.tags != null &&
                        ...
                        : const SizedBox(),
                    widget.product.nutrition != null &&
                            widget.product.nutrition!.isNotEmpty
                        ? Column(
                            children: [
                              Container(
                                width: double.infinity,
                        ...
                        : const SizedBox(),
                    widget.product.allergies != null &&
                            widget.product.allergies!.isNotEmpty
                        ? Column(
                            children: [
                              Container(
                                width: double.infinity,
                    ...
                    if (Get.find<SplashController>()
                            ...
                            .systemTaxType ==
                        'product_wise')
                      (widget.product.taxData != null &&
                              widget.product.taxData!.isNotEmpty)
                          ? Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(
                                    Dimensions.radiusDefault - 2),
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Row(children: [
                                        Text(
                                            '${widget.product.taxData?[index].name}:',
                                            style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall)),
                                        const SizedBox(
                    ...
                    if (Get.find<SplashController>()
                        ...
                        'product_wise')
                      SizedBox(
                          height: widget.product.taxData != null &&
                                  widget.product.taxData!.isNotEmpty
                              ? Dimensions.paddingSizeDefault
                              : 0),
            ...
            Container(
              ...
              child: Row(
                children: [
                  widget.product.stockType != 'unlimited' &&
                          ((widget.product.variations != null &&
                              widget.product.variations!.isNotEmpty))
                      ? Expanded(
                          child: Container(
