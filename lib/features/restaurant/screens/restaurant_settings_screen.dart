...
import 'package:toto_partner/common/widgets/custom_bottom_sheet_widget.dart';
...
import 'package:toto_partner/common/widgets/custom_ink_well_widget.dart';
import 'package:toto_partner/common/widgets/custom_snackbar_widget.dart';
import 'package:toto_partner/common/widgets/custom_text_field_widget.dart';
import 'package:toto_partner/common/widgets/custom_text_form_field_widget.dart';
import 'package:toto_partner/common/widgets/custom_tool_tip_widget.dart';
import 'package:toto_partner/common/widgets/switch_button_widget.dart';
...
import 'package:toto_partner/features/restaurant/widgets/setting_confirmation_bottom_sheet.dart';
...
import 'package:toto_partner/features/restaurant/widgets/daily_time_widget.dart';
import 'package:toto_partner/helper/type_converter.dart';
          ...
          Expanded(
            ...
            child:
                ...
                child: Column(children: [
                    ...
                    onTap: () {
                      showCustomBottomSheet(
                        child: SettingConfirmationBottomSheet(
                          title: restController.isDeliveryEnabled
                              ? 'want_to_disable_the_home_delivery_option'.tr
                              : 'want_to_enable_the_home_delivery_option'.tr,
                          description: restController.isDeliveryEnabled
                              ? 'if_disabled_the_home_delivery_option_will_be_hidden_from_your_restaurant'
                                  .tr
                              : 'if_enabled_customers_can_order_food_for_home_delivery'
                                  .tr,
                          onConfirm: () {
                            Get.back();
                            restController.setHomeDelivery(
                                !restController.isDeliveryEnabled);
                          },
                        ),
                      );
                    },
                  ...
                  Get.find<SplashController>().configModel!.takeAway!
                      ? SwitchButtonWidget(
                          ...
                          onTap: () {
                            showCustomBottomSheet(
                              child: SettingConfirmationBottomSheet(
                                title: restController.isTakeAwayEnabled
                                    ? 'want_to_disable_the_takeaway_option'.tr
                                    : 'want_to_enable_the_takeaway_option'.tr,
                                description: restController.isTakeAwayEnabled
                                    ? 'if_disabled_the_takeaway_option_will_be_hidden_from_your_restaurant'
                                        .tr
                                    : 'if_enabled_customers_can_place_takeaway_self_pickup_orders'
                                        .tr,
                                onConfirm: () {
                                  Get.back();
                                  restController.setTakeAway(
                                      !restController.isTakeAwayEnabled);
                                },
                              ),
                            );
                          },
                  ...
                  SwitchButtonWidget(
                    ...
                    onTap: () {
                      showCustomBottomSheet(
                        child: SettingConfirmationBottomSheet(
                          title: restController.isDineInEnabled!
                              ? 'want_to_disable_the_dine_in_option'.tr
                              : 'want_to_enable_the_dine_in_option'.tr,
                          description: restController.isDineInEnabled!
                              ? 'if_disabled_the_dine_in_option_will_be_hidden_from_your_restaurant'
                                  .tr
                              : 'if_enabled_customers_can_place_dine_in_orders'
                                  .tr,
                          onConfirm: () {
                            Get.back();
                          ...
                          child: CustomDropdownWidget<int>(
                            onChange: (int? value, int index) {
                              restController.setTimeType(
                                  type: restController.timeTypes[index]);
                            },
                            ...
                            Transform.scale(
                              ...
                              child: CupertinoSwitch(
                                ...
                                onChanged: (onChanged) {
                                  showCustomBottomSheet(
                                    child: SettingConfirmationBottomSheet(
                                      title: restController.instantOrder
                                          ? 'want_to_disable_the_instant_order_option'
                                              .tr
                                          : 'want_to_enable_the_instant_order_option'
                                              .tr,
                                      description: restController.instantOrder
                                          ? 'if_disabled_customers_can_not_order_instantly'
                                              .tr
                                          : 'if_enabled_customers_can_order_instantly'
                                              .tr,
                                      onConfirm: () {
                                        Get.back();
                                        restController
                                            .setInstantOrder(onChanged);
                                      },
                                    ),
                                  );
                                },
                            ...
                            Transform.scale(
                              ...
                              child: CupertinoSwitch(
                                ...
                                onChanged: (onChanged) {
                                  showCustomBottomSheet(
                                    child: SettingConfirmationBottomSheet(
                                      title: restController.scheduleOrder
                                          ? 'want_to_disable_the_schedule_order_option'
                                              .tr
                                          : 'want_to_enable_the_schedule_order_option'
                                              .tr,
                                      description: restController.scheduleOrder
                                          ? 'if_disabled_customers_can_not_order_schedule_wise'
                                              .tr
                                          : 'if_enabled_customers_can_order_schedule_wise'
                                              .tr,
                                      onConfirm: () {
                                        Get.back();
                                        restController
                                            .setScheduleOrder(onChanged);
                                      },
                                    ),
                                  );
                                },
                  ...
                  SwitchButtonWidget(
                    ...
                    onTap: () {
                      showCustomBottomSheet(
                        child: SettingConfirmationBottomSheet(
                          title: restController.isSubscriptionOrderEnabled!
                              ? 'want_to_disable_the_subscription_order_option'
                                  .tr
                              : 'want_to_enable_the_subscription_order_option'
                                  .tr,
                          description: restController
                                  .isSubscriptionOrderEnabled!
                              ? 'if_disabled_the_subscription_based_order_option_will_be_hidden_from_your_restaurant'
                                  .tr
                              : 'if_enabled_customers_can_order_food_on_a_subscription_basis_from_your_restaurant'
                                  .tr,
                          onConfirm: () {
                            Get.back();
                ...
                child: Column(children: [
                  ...
                  SwitchButtonWidget(
                    ...
                    onTap: () {
                      showCustomBottomSheet(
                        child: SettingConfirmationBottomSheet(
                          title: restController.isHalalEnabled!
                              ? 'want_to_disable_the_halal_tag_status'.tr
                              : 'want_to_enable_the_halal_tag_status'.tr,
                          description: restController.isHalalEnabled!
                              ? 'if_disabled_customers_can_not_see_halal_tag_on_product.'
                                  .tr
                              : 'if_enabled_customers_can_see_halal_tag_on_product'
                                  .tr,
                          onConfirm: () {
                            Get.back();
                                ...
                                child: Row(children: [
                                  ...
                                  Text('veg'.tr,
                                      style: robotoMedium.copyWith(
                                          color: restController.isRestVeg!
                                              ? Theme.of(context)
                                                  .textTheme
                                                  .bodyLarge
                                                  ?.color
              ...
              Row(children: [
                ...
                CustomToolTip(
                    message:
                        'if_enabled_the_gst_number_will_be_shown_in_the_invoice'
                            .tr,
                    size: 16),
              ]),
              const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                child: Column(children: [
                  ...
                  Padding(
                    ...
                    child: CustomTextFieldWidget(
                      hintText: 'eg_18'.tr,
                      labelText:
                          '${'gst_amount'.tr} (${Get.find<SplashController>().configModel!.currencySymbol})',
                        ...
                        Row(children: [
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.all(
                                  Dimensions.paddingSizeSmall),
                              child: Text('active_extra_package_charge'.tr,
                                  style: robotoRegular),
                            ),
                          ),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                        ...
                        Padding(
                          ...
                          child: Column(children: [
                            ...
                            CustomTextFieldWidget(
                              hintText: 'eg_18'.tr,
                              labelText:
                                  '${'extra_packaging_amount'.tr} (${Get.find<SplashController>().configModel!.currencySymbol})',
                        ...
                        Row(children: [
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.all(
                                  Dimensions.paddingSizeSmall),
                              child: Text('custom_date_order_status'.tr,
                                  style: robotoRegular),
                            ),
                          ),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                  ...
                  ? Container(
                      ...
                      child: Column(children: [
                        CustomTextFieldWidget(
                          hintText: 'eg_18'.tr,
                          labelText:
                              '${'per_km_delivery_charge'.tr} (${Get.find<SplashController>().configModel!.currencySymbol})',
                        ...
                        Row(children: [
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.all(
                                  Dimensions.paddingSizeSmall),
                              child: Text('free_delivery_distance_km'.tr,
                                  style: robotoRegular),
                            ),
                          ),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
          ...
          Container(
            ...
            child: CustomButtonWidget(
              ...
              onPressed: () async {
                ...
                if (restController.isExtraPackagingEnabled! &&
                  ...
                  showCustomSnackBar(
                      'per_km_charge_can_not_be_more_then_maximum_charge'.tr);
                } else if (_restaurant.selfDeliverySystem == 1 &&
                    minimumFee.isNotEmpty &&
                    (maximumFee.isNotEmpty
                        ? (double.parse(minimumFee) > double.parse(maximumFee))
                        : false)) {
                  showCustomSnackBar(
                      'minimum_charge_can_not_be_more_then_maximum_charge'.tr);
                  ...
                  _restaurant.scheduleAdvanceDineInBookingDuration =
                      dineInAdvanceTime.isNotEmpty
                          ...
                          : 0;
                  _restaurant.scheduleAdvanceDineInBookingDurationTimeFormat =
                      restController.selectedTimeType;
                  _restaurant.customOrderDate = customOrderDate.isNotEmpty
                  ...
                  _restaurant.orderSubscriptionActive =
                      restController.isSubscriptionOrderEnabled;
