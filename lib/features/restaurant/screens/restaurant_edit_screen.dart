...
import 'package:toto_partner/common/widgets/validate_check.dart';
...
import 'package:toto_partner/helper/custom_validator.dart';
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text('image_format_and_ratio_for_logo'.tr,
                          style: robotoRegular.copyWith(
                              fontSize: Dimensions.fontSizeSmall,
                              color: Theme.of(context).hintColor)),
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: restController.pickedLogo != null
                                    ...
                                    : widget.restaurant.logoFullUrl != null
                                        ? CustomImageWidget(
                                            image:
                                                '${widget.restaurant.logoFullUrl}',
                                            height: 120,
                                            width: 120,
                                            fit: BoxFit.cover,
                                          )
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                      Text('image_format_and_ratio_for_cover'.tr,
                          style: robotoRegular.copyWith(
                              fontSize: Dimensions.fontSizeSmall,
                              color: Theme.of(context).hintColor)),
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: restController.pickedCover != null
                                  ...
                                  : widget.restaurant.coverPhotoFullUrl != null
                                      ? CustomImageWidget(
                                          image:
                                              '${widget.restaurant.coverPhotoFullUrl}',
                                          height: 140,
                            ...
                            child: InkWell(
                              ...
                              child: DottedBorder(
                                ...
                                radius: const Radius.circular(
                                    Dimensions.radiusDefault),
                                child:
                                    SizedBox(width: context.width, height: 140),
                              ),
                            ),
                          ),
                        ]),
                  ...
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFieldWidget(
                            hintText:
                                '${'meta_title'.tr} (${_languageList[_tabController!.index].value!})',
                            labelText: 'title'.tr,
                            controller:
                                _metaTitleController[_tabController!.index],
                            capitalization: TextCapitalization.words,
                            focusNode: _metaTitleNode[_tabController!.index],
                            nextFocus: _tabController!.index !=
                                    _languageList.length - 1
                                ? _metaDescriptionNode[_tabController!.index]
                          ...
                          CustomTextFieldWidget(
                            hintText:
                                '${'meta_description'.tr} (${_languageList[_tabController!.index].value!})',
                  ...
                  Stack(clipBehavior: Clip.none, children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: restController.pickedMetaImage != null
                            ? GetPlatform.isWeb
                                ? Image.network(
                                    restController.pickedMetaImage!.path,
                                    width: 120,
                                    height: 120,
                                    fit: BoxFit.cover)
                                : Image.file(
                                    File(restController.pickedMetaImage!.path),
                                    width: 120,
                                    height: 120,
                                    fit: BoxFit.cover)
                            : CustomImageWidget(
                ...
                if (defaultNameNull) {
                  ...
                  for (int index = 0; index < _languageList.length; index++) {
                    ...
                    translation.add(Translation(
                      locale: _languageList[index].key,
                      key: 'meta_title',
                      value: _metaTitleController[index].text.trim().isNotEmpty
                  ...
                  restController.updateRestaurantBasicInfo(
                      _restaurant, translation);
                }
              },
