...
import 'package:toto_partner/common/models/config_model.dart';
...
import 'package:toto_partner/common/widgets/custom_drop_down_button.dart';
...
import 'package:toto_partner/common/widgets/custom_time_picker_widget.dart';
...
import 'package:toto_partner/features/restaurant/widgets/stock_section_widget.dart';
import 'package:toto_partner/features/splash/controllers/splash_controller.dart';
import 'package:toto_partner/features/restaurant/domain/models/variation_model.dart';
...
import 'package:toto_partner/features/restaurant/widgets/variation_view_widget.dart';
...
class _AddProductScreenState extends State<AddProductScreen>
  ...
  void initState() {
    ...
    Get.find<RestaurantController>()
        .initNutritionAndAllergicIngredientsData(widget.product);
    ...
    if (_update) {
      ...
      _stockTextController.text =
          _product!.itemStock == 0 ? '0' : _product!.itemStock!.toString();
        ...
        child: GetBuilder<RestaurantController>(builder: (restController) {
          return GetBuilder<CategoryController>(builder: (categoryController) {
            ...
            if (restController.nutritionSuggestionList != null) {
              for (int index = 0;
                  index < restController.nutritionSuggestionList!.length;
                  index++) {
            ...
            if (restController.allergicIngredientsSuggestionList != null) {
              for (int index = 0;
                  index <
                      restController.allergicIngredientsSuggestionList!.length;
                  index++) {
            ...
            if (_update) {
              if (restController.vatTaxList != null &&
                  restController.selectedVatTaxIdList.isEmpty &&
                  widget.product!.taxVatIds != null &&
                  widget.product!.taxVatIds!.isNotEmpty) {
                restController.preloadVatTax(
                    vatTaxList: widget.product!.taxVatIds!);
              }
            }
                                    ...
                                    Column(children: [
                                      ...
                                      SizedBox(
                                          height: restController
                                              ...
                                              ? Dimensions.paddingSizeSmall
                                              : 0),
                                      restController.selectedNutritionList !=
                                              null
                                          ? SizedBox(
                                              height: restController
                                                      .selectedNutritionList!
                                          ...
                                          child: Autocomplete<int>(
                                            optionsBuilder:
                                              ...
                                              if (value.text.isEmpty) {
                                                ...
                                                return allergicIngredientsSuggestion
                                                    .where((allergicIngredients) =>
                                                        restController
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    final vatTaxName =
                                                        restController
                                                                .selectedVatTaxNameList[
                                                            index];
                                                    final vatTaxId = restController
                                                            .selectedVatTaxIdList[
                                                        index];
                                                    final taxRate = restController
                                                            .selectedTaxRateList[
                                                        index];
                                                    return Padding(
                                                      padding: const EdgeInsets
                      ...
                      child: CustomButtonWidget(
                        ...
                        onPressed: () {
                              ...
                              for (Option option in variationModel.options!) {
                                if (option.optionNameController!.text.isEmpty) {
                                  ...
                                  variationOptionPriceEmpty = true;
                                        ...
                                        .optionStockController!.text.isEmpty &&
                          ...
                          if (defaultDataNull) {
                            ...
                            showCustomSnackBar(
                                'enter_option_stock_for_every_variation'.tr);
                            ...
                            for (var index in restController.selectedAddons!) {
                              _product!.addOns!.add(Get.find<AddonController>()
                                  .addonList![index]);
                            }
                            _product!.itemStock =
                            ...
                            if (Get.find<SplashController>()
                              ...
                              _product?.taxVatIds = [];
                              _product?.taxVatIds =
                                  restController.selectedVatTaxIdList;
                            }
