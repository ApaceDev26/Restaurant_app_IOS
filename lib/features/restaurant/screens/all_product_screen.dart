                    ...
                    InkWell(
                        ...
                        if (Get.find<ProfileController>()
                          ...
                          if (Get.find<ProfileController>()
                              ...
                              Get.find<ProfileController>()
                                  ...
                                  'subscription') {
                            showCustomSnackBar(
                                'your_food_add_limit_is_over'.tr);
                          } else {
                            if (restaurant != null) {
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.add,
                            color: Theme.of(context).cardColor, size: 25),
                      ),
                    ),
                  ])
                : const SizedBox();
                    ...
                    restController.categoryNameList != null
                        ? SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                                  restController.categoryNameList!.length,
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () => restController.setCategory(
                                      index: index,
                                      foodType: 'all',
                                      stockType: 'all'),
                                  child: Container(
                    ...
                    ProductViewWidget(
                      ...
                      onVegFilterTap: (String type) {
                        Get.find<RestaurantController>().getProductList(
                            offset: '1',
                            foodType: type,
                            stockType: restController.selectedStockType,
                            categoryId: restController.categoryId);
                      },
                    ),
                  ]),
                )
