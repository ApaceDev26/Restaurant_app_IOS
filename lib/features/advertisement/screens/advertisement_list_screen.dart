...
import 'package:toto_partner/features/advertisement/widgets/empty_ads_view.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AdvertisementController>(
      ...
      return Scaffold(
        ...
        floatingActionButton: advertisementController.advertisementList !=
                    null &&
                advertisementController.advertisementList!.isNotEmpty
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                                      ...
                                      if (option.title == "edit_ads") {
                                        if (status == 'running') {
                                          showCustomBottomSheet(
                                            ...
                                            title: "do_you_want_to_edit",
                                            description:
                                                "confirm_edit_ads_dialog_description",
                                            status: option.title,
                      ...
                      // hasDivider ? Divider(color: Theme.of(context).hintColor) : const SizedBox(),
                    ]),
                  ),
                );
              }),
