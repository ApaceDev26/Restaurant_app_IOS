...
class AddonRepository implements AddonRepositoryInterface<AddOns> {
  ...
  Future<bool> add(AddOns addonModel) async {
    ...
    Response response =
        await apiClient.postData(AppConstants.addAddonUri, body);
  ...
  @override
  Future<List<AddonCategoryModel>?> getAddonCategory(
      {required int moduleId}) async {
    List<AddonCategoryModel>? addonCategoryList;
    Response response = await apiClient
        .getData('${AppConstants.addonCategoryList}?module_id=$moduleId');
