    ...
    if (_update) {
      if (widget.addon!.addonCategoryId != null) {
        Get.find<AddonController>()
            .setAddonCategory(widget.addon!.addonCategoryId);
      }

      if (Get.find<RestaurantController>().vatTaxList != null &&
          Get.find<RestaurantController>().selectedVatTaxIdList.isEmpty &&
          widget.addon!.taxVatIds != null &&
          widget.addon!.taxVatIds!.isNotEmpty) {
        Get.find<RestaurantController>()
            .preloadVatTax(vatTaxList: widget.addon!.taxVatIds!);
      }
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
          title:
              widget.addon != null ? 'update_addon'.tr : 'add_new_addons'.tr),
                ...
                child: Column(children: [
                  CustomCard(
                    ...
                    child: Column(children: [
                      ...
                      CustomTextFieldWidget(
                        hintText:
                            '${'name'.tr} (${_languageList?[_tabController!.index].value}) *',
                        labelText: 'name'.tr,
                      ...
                      CustomTextFieldWidget(
                        hintText:
                            '${'price'.tr} (${Get.find<SplashController>().configModel?.currencySymbol})',
                        labelText:
                            '${'price'.tr} (${Get.find<SplashController>().configModel?.currencySymbol})',
                  ...
                  CustomCard(
                    ...
                    child: Column(children: [
                        ...
                        Container(
                          ...
                          child: Row(children: [
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  restaurantController.setStockTypeIndex(
                                      0, true);
                                },
                                child: Row(children: [
                                  Radio(
                      ...
                      SizedBox(
                          height: restaurantController.stockTypeIndex == 0 ||
                  ...
                  CustomCard(
                    ...
                    child: Column(children: [
                      CustomDropdownButton(
                        ...
                        dropdownMenuItems: addonController.addonCategoryList
                        ...
                        onChanged: (String? value) {
                          ...
                          int? id = addonController.addonCategoryList
                      ...
                      SizedBox(
                          height: Get.find<SplashController>()
                              ...
                              ? Dimensions.paddingSizeExtraLarge
                              : 0),
                      Get.find<SplashController>().configModel!.systemTaxType ==
                              'product_wise'
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                  CustomDropdownButton(
                                    dropdownMenuItems: restaurantController
                                        .vatTaxList
                                        ?.map((e) {
                                      bool isInVatTaxList = restaurantController
                                    ...
                                    onChanged: (String? value) {
                                      final selectedVatTax =
                                          restaurantController.vatTaxList
                                              ?.firstWhere((vatTax) =>
                                                  vatTax.name == value);
                                      if (selectedVatTax != null) {
                                        restaurantController.setSelectedVatTax(
                                            selectedVatTax.name,
                                            selectedVatTax.id,
                                            selectedVatTax.taxRate);
                                      }
                                    },
                                    selectedValue:
                                        restaurantController.selectedVatTaxName,
                                  ),
                                  SizedBox(
                                      height: restaurantController
                                              .selectedVatTaxNameList.isNotEmpty
                                  ...
                                  Wrap(
                                    children: List.generate(
                                        restaurantController
                                            .selectedVatTaxNameList
                                            .length, (index) {
                                      final vatTaxName = restaurantController
                                          .selectedVatTaxNameList[index];
                                      final vatTaxId = restaurantController
                                          .selectedVatTaxIdList[index];
                                      final taxRate = restaurantController
                ...
                onPressed: () {
                  ...
                  if (name.isEmpty) {
                    ...
                    showCustomSnackBar('select_addon_category'.tr);
                              ...
                              .systemTaxType ==
                          'product_wise' &&
                      restaurantController.selectedVatTaxIdList.isEmpty) {
                    ...
                    if (Get.find<SplashController>()
                        ...
                        'product_wise') {
                      selectedVatTaxIds =
                          restaurantController.selectedVatTaxIdList;
                    }
                    ...
                    AddOns addon = AddOns(
                      ...
                      stockType: restaurantController.stockTypeIndex == 0
                          ...
                          : restaurantController.stockTypeIndex == 1
                              ? 'limited'
                              : 'daily',
                      taxVatIds: selectedVatTaxIds,
                      addonCategoryId: addonController.addonCategoryId,
                    );
