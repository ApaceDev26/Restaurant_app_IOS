...
import 'package:toto_partner/features/addon/widgets/addon_delete_bottom_sheet.dart';
                            ...
                            InkWell(
                              onTap: () {
                                if (Get.find<ProfileController>()
                                    ...
                                    .restaurants![0]
                                    .foodSection!) {
                                  Get.toNamed(RouteHelper.getAddAddonRoute(
                                      addon:
                              ...
                              onTap: () {
                                if (Get.find<ProfileController>()
                                  ...
                                  showCustomBottomSheet(
                                    child: AddonDeleteBottomSheet(
                                        addonId: addonController
                                            .addonList![index].id!),
                                  );
                                } else {
                                  showCustomSnackBar(
