...
import 'package:toto_partner/features/chat/widgets/conversation_details_shimmer_widget.dart';
...
import 'package:toto_partner/features/chat/widgets/message_bubble_widget.dart';
            ...
            title: Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                chatController.messageModel != null
                    ? Text(
                        '${chatController.messageModel?.conversation?.receiver?.fName ?? Get.find<SplashController>().configModel!.businessName}'
