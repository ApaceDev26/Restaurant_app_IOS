...
class AppConstants {
  static const String appName = 'Toto Food Partner';
  static const double appVersion = 1.0;

  /// Android versionCode — keep in sync with pubspec `version: x.y.z+THIS`
  static const int appVersionCode = 7;
  static bool onTapon = true;
  ...
  static const String restaurantBasicInfoUpdateUri =
  ...
  static const String earningHistoryUri = '/api/v1/vendor/earning-history';
  ...
  static const String addDineInTableAndTokenUri =
      '/api/v1/vendor/add-dine-in-table-number';
  ...
  ///Qr Menu
  static const String viewQrMenuUri = '/api/v1/vendor/qr-code';
  static const String updateQrMenuSetupUri = '/api/v1/vendor/qr-code/update';
