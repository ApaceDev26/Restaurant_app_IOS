import 'dart:convert';
import 'package:toto_partner/common/screens/payment_screen.dart';
import 'package:toto_partner/features/addon/screens/add_addon_screen.dart';
import 'package:toto_partner/features/advertisement/screens/advertisement_details_screen.dart';
import 'package:toto_partner/features/advertisement/screens/advertisement_list_screen.dart';
import 'package:toto_partner/features/advertisement/screens/create_advertisement_screen.dart';
import 'package:toto_partner/features/business/screens/subscription_payment_screen.dart';
import 'package:toto_partner/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:toto_partner/features/campaign/screens/campaign_details_screen.dart';
import 'package:toto_partner/features/campaign/screens/campaign_screen.dart';
import 'package:toto_partner/features/category/screens/category_screen.dart';
import 'package:toto_partner/features/chat/domain/models/notification_body_model.dart';
import 'package:toto_partner/features/category/domain/models/category_model.dart';
import 'package:toto_partner/features/chat/domain/models/conversation_model.dart';
import 'package:toto_partner/features/dashboard/screens/dashboard_screen.dart';
import 'package:toto_partner/features/deliveryman/domain/models/delivery_man_model.dart';
import 'package:toto_partner/features/deliveryman/screens/add_delivery_man_screen.dart';
import 'package:toto_partner/features/deliveryman/screens/delivery_man_details_screen.dart';
import 'package:toto_partner/features/deliveryman/screens/delivery_man_screen.dart';
import 'package:toto_partner/features/disbursement/screens/add_withdraw_method_screen.dart';
import 'package:toto_partner/features/disbursement/screens/disbursement_menu_screen.dart';
import 'package:toto_partner/features/disbursement/screens/disbursement_screen.dart';
import 'package:toto_partner/features/disbursement/screens/withdraw_method_screen.dart';
import 'package:toto_partner/features/expense/screens/expense_screen.dart';
import 'package:toto_partner/features/auth/screens/forget_pass_screen.dart';
import 'package:toto_partner/features/auth/screens/new_pass_screen.dart';
import 'package:toto_partner/features/auth/screens/verification_screen.dart';
import 'package:toto_partner/features/html/screens/html_viewer_screen.dart';
import 'package:toto_partner/features/language/screens/language_screen.dart';
import 'package:toto_partner/features/notification/screens/notification_screen.dart';
import 'package:toto_partner/features/order/domain/models/order_model.dart';
import 'package:toto_partner/features/payment/screens/bank_info_screen.dart';
import 'package:toto_partner/features/payment/screens/payment_history_screen.dart';
import 'package:toto_partner/features/payment/screens/payment_successful_screen.dart';
import 'package:toto_partner/features/payment/screens/wallet_screen.dart';
import 'package:toto_partner/features/payment/screens/withdraw_request_history_screen.dart';
import 'package:toto_partner/features/reports/screens/tax/screens/tax_report_screen.dart';
import 'package:toto_partner/features/restaurant/domain/models/product_model.dart';
import 'package:toto_partner/features/order/screens/order_details_screen.dart';
import 'package:toto_partner/features/pos/screens/pos_screen.dart';
import 'package:toto_partner/features/profile/domain/models/profile_model.dart';
import 'package:toto_partner/features/addon/screens/addon_screen.dart';
import 'package:toto_partner/features/auth/screens/restaurant_registration_screen.dart';
import 'package:toto_partner/features/auth/screens/sign_in_screen.dart';
import 'package:toto_partner/features/chat/screens/chat_screen.dart';
import 'package:toto_partner/features/chat/screens/conversation_screen.dart';
import 'package:toto_partner/features/coupon/screens/coupon_screen.dart';
import 'package:toto_partner/features/profile/screens/profile_screen.dart';
import 'package:toto_partner/features/profile/screens/update_profile_screen.dart';
import 'package:toto_partner/features/reports/screens/campaign/screens/campaign_report_screen.dart';
import 'package:toto_partner/features/reports/screens/food/screens/food_report_screen.dart';
import 'package:toto_partner/features/reports/screens/order/screens/order_report_screen.dart';
import 'package:toto_partner/features/reports/screens/reports_screen.dart';
import 'package:toto_partner/features/reports/screens/transaction/screens/transaction_report_screen.dart';
import 'package:toto_partner/features/restaurant/domain/models/review_model.dart';
import 'package:toto_partner/features/restaurant/screens/add_product_screen.dart';
import 'package:toto_partner/features/restaurant/screens/all_product_screen.dart';
import 'package:toto_partner/features/restaurant/screens/announcement_screen.dart';
import 'package:toto_partner/features/restaurant/screens/product_details_screen.dart';
import 'package:toto_partner/features/restaurant/screens/restaurant_screen.dart';
import 'package:toto_partner/features/restaurant/screens/restaurant_edit_screen.dart';
import 'package:toto_partner/features/restaurant/screens/restaurant_settings_screen.dart';
import 'package:toto_partner/features/review/screens/customer_review_screen.dart';
import 'package:toto_partner/features/review/screens/review_reply_screen.dart';
import 'package:toto_partner/features/splash/screens/splash_screen.dart';
import 'package:toto_partner/features/subscription/screens/my_subscription_screen.dart';
import 'package:toto_partner/features/menu/screens/skylon_it_screen.dart';
import 'package:toto_partner/features/support/screens/support_screen.dart';
import 'package:toto_partner/features/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static String getOrderDetailsRoute(int? orderID,
      ...
      '$orderDetails?id=$orderID&from_notification=$fromNotification';
  ...
  static String getCampaignDetailsRoute(
          {int? id, bool fromNotification = false}) =>
  ...
  static String getPaymentRoute(String? paymentMethod, String? redirectUrl,
      int? restaurantId, bool? isSubscriptionPayment, int? packageId) {
  ...
  static String getAdvertisementDetailsScreen(
          {required int? advertisementId, bool? fromNotification}) =>
      '$advertisementDetails?advertisementId=$advertisementId&fromNotification=$fromNotification';
  ...
  static String getSubscriptionPaymentRoute(
      ...
      '$subscriptionPayment?id=$restaurantId&package_id=$packageId';
  static String getMySubscriptionRoute({bool fromNotification = false}) =>
      '$mySubscription?from_notification=$fromNotification';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          bool isSubscriptionPayment =
              Get.parameters['is_subscription_payment'] == 'true';
    ...
    GetPage(
        name: advertisementList, page: () => const AdvertisementListScreen()),
    GetPage(
        name: createAdvertisement,
        page: () => const CreateAdvertisementScreen()),
    GetPage(
    ...
    GetPage(
        ...
        page: () => AdvertisementDetailsScreen(
              id: int.parse(Get.parameters['advertisementId']!),
    ...
    GetPage(
        ...
        page: () => SubscriptionPaymentScreen(
            ...
            packageId: int.parse(Get.parameters['package_id']!))),
    GetPage(
        name: mySubscription,
        page: () => MySubscriptionScreen(
            fromNotification: Get.parameters['from_notification'] == 'true')),
    GetPage(name: allProducts, page: () => const AllProductScreen()),
    GetPage(name: helpSupport, page: () => const SupportScreen()),
    GetPage(name: skylonIt, page: () => const SkylonItScreen()),
  ];
}
