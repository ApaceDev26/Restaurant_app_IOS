...
import 'package:toto_partner/features/payment/widgets/fund_payment_dialog_widget.dart';
...
class MyInAppBrowser extends InAppBrowser {
  ...
  void _redirect(String url, int? restaurantId, bool? isSubscriptionPayment,
      int? packageId) {
    if (_canRedirect) {
      bool isSuccess =
