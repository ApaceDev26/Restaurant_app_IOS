...
import 'package:toto_partner/api/api_checker.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/foundation.dart';
import 'package:http_parser/http_parser.dart';
import 'package:toto_partner/common/models/error_response.dart';
import 'package:toto_partner/helper/image_converter.dart';
...
class ApiClient extends GetxService {
  ...
  ApiClient({required this.appBaseUrl, required this.sharedPreferences}) {
    ...
    updateHeader(
        token, sharedPreferences.getString(AppConstants.languageCode), type);
  }

  void updateHeader(String? token, String? languageCode, String? type) {
    _mainHeaders = {
    ...
    try {
      ...
      for (MultipartBody multipart in multipartBody) {
        if (multipart.file != null) {
          final converted = await ImageConverter.toWebp(
            multipart.file!,
            key: multipart.key,
          );
